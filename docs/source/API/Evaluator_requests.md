...
1. The correlation summary file (`correlation_summary_[evaluator_name].csv`)
...
2. The cell-type specific expression file (`cell_type_specific_expression_[evaluator_name].csv`)
