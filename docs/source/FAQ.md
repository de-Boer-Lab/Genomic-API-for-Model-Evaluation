...
No, only static models with fixed paramaters/models weights can be used in the GAME framework. That being said foundational models that had already been fine-tuned to predict genome regulation from DNA sequence are fully compatible with GAME. 
...
Yes, if you have private data that you don't want to share with others, you can add an encryption layer ontop of your client. More on this coming soon!
